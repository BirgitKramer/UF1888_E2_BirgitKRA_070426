# La informacion esta repartida en varias tablas
...
- sale_order_line -> guarda el datalle: que producto, cantidad, precio...
- res_partner -> guarda el cliente
- product_product / product_template guardan el producto

**para sacar un informe util hay que relacionar tablas.**
...
```
![alt text](sale_order_070426.png)
...
```
![alt text](consultas_ventas_nombre_070426-1.png)
```sql
SELECT
    rp.name AS cliente,
